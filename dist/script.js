...
let FIRST = document.getElementById("tablerow1");
let SECOUND = document.getElementById("tablerow2");
let THIRD = document.getElementById("tablerow3");
let FOURTH = document.getElementById("tablerow4");
...
function hidetable(){
  ...
  // The API URL to fetch the data
  const apiUrl = 'http://192.168.1.248:8080/api/vehicle';
  ...
  fetch(apiUrl, { method: 'GET' })
    ...
    .then(data => {
      ...
      data.forEach(item => {
        ...
        savingCell.textContent = item.saving;
